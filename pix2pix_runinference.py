...
def load_examples():
    ...
    if len(input_paths) == 0:
        ...
        print(decode) # <function decode_png at 0x113c491b8>
...
def create_model(inputs, targets):
    ...
    with tf.variable_scope("generator"):
        ...
        print(inputs) # Tensor("batch:1", shape=(1, 256, 256, 3), dtype=float32)
        outputs = create_generator(inputs, out_channels)
        print(outputs) # Tensor("generator/decoder_1/Tanh:0", shape=(1, 256, 256, 3), dtype=float32)
...
def main():
    ...
    # get input node and output node names
